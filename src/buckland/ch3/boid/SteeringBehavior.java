...
import static buckland.ch3.common.misc.Stream_Utility_function.*;
import static buckland.ch3.common.misc.CppToJava.*;
...
//------------------------------------------------------------------------
    ...
    private final ArrayList<Vehicle> predators = new ArrayList<Vehicle>();
    ...
    private final List<Vector2D> m_Feelers;
    //the length of the 'feeler/s' used in wall detection
    private final double m_dWallDetectionFeelerLength;
    //the current position on the wander circle the agent is
    //attempting to steer towards
    private final Vector2D m_vWanderTarget;
    //explained above
    ...
    private final double m_dWeightWander;
    private final double m_dWeightObstacleAvoidance;
    private final double m_dWeightWallAvoidance;
    private final double m_dWeightSeek;
    private final double m_dWeightFlee;
    private final double m_dWeightArrive;
    private final double m_dWeightPursuit;
    private final double m_dWeightOffsetPursuit;
    private final double m_dWeightInterpose;
    private final double m_dWeightHide;
    private final double m_dWeightEvade;
    private final double m_dWeightFollowPath;
    //how far the agent can 'see'
    private final double m_dViewDistance;
    //pointer to any current path
    private final Path m_pPath;
...
//    /**
//     * Computes the turnaround time. See p.95 in book.
//     * @param pAgent This agent
//     * @param TargetPos Target agent
//     * @return Turnaround time in seconds.
//     */
//    private double TurnaroundTime(final Vehicle pAgent, Vector2D TargetPos) {
//        Vector2D toTarget = Vec2DNormalize(sub(TargetPos,pAgent.Pos()));
//        
...
//---------------------------------dtor ----------------------------------
    ...
    protected Vector2D CalculatePrioritized() {
        ...
        if (On(behavior_type.evade)) {
            ...
            // Evade the nearest target
            double minDist = Double.MAX_VALUE;
            
            Vehicle nearest = null;
            
            for(Vehicle predator: predators) {
                Vector2D pos = sub(this.m_pVehicle.m_vPos, predator.m_vPos);
                
                double dist = pos.LengthSq();
...
//            force = mul(Evade(m_pTargetAgent1), m_dWeightEvade);
            force = mul(Evade(nearest), m_dWeightEvade);
